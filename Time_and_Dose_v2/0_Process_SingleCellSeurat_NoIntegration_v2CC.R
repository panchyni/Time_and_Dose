...
seurat_list <- list(seurat_A,seurat_B)
...
integration.combined <- ScaleData(integration.combined, vars.to.regress=c("nCount_RNA","percent.mito","S.Score","G2M.Score") ,verbose = FALSE)
...
saveRDS(integration.combined,'SeuratData/Seurat_integrated_TimeOnly_FullCorr_hg38_v2CC.rds')
...
#seurat_concentration_scale <- ScaleData(seurat_C,verbose=FALSE)
...
saveRDS(seurat_concentration_scale,"SeuratData/Seurat_concentration_DoseOnly_FullCorr_hg38_v2CC.rds")
