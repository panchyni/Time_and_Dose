...
save(results_mat, file = "MultiCancerResultsTable_QuartCon_LogP1_Alt.RData")
save(activegenes_mat, file = "MultiCancerGeneCountTable_QuartCon_LogP1_AltL.RData")

save(activegenes_list, file = "MultiCancerGeneLists_QuartCon_LogP1_Alt.RData")
save(i_list, file = "MultiCancerGeneilist_QuartCon_LogP1L_Alt.RData")
save(j_list, file = "MultiCancerjlist_QuartCon_LogP1_Alt.RData")
...
load("MultiCancerResultsTable_QuartCon_LogP1_Alt.RData")
load("MultiCancerGeneCountTable_QuartCon_LogP1_AltL.RData")
