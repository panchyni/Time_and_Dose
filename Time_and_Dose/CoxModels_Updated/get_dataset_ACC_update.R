#ACC_dataset.R
#Purpose: TCGA-ACC analysis

### Setup Environemt ###

# Folder
setwd("<path_to_folder>/Time_and_Doses/CoxModels_Updated/")
...
coad_query <- GDCquery(project       = "TCGA-ACC",
...
save(cox_df, file = "Data/TCGA-ACC/ACC_df_fpkm_update.RData")
