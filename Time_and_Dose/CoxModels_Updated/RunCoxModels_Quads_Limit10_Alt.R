...
save(results_mat, file = "MultiCancerResultsTable_QuartALL_Alt.RData")
save(activegenes_mat, file = "MultiCancerGeneCountTable_QuartAL_AltL.RData")

save(activegenes_list, file = "MultiCancerGeneLists_QuartALL_Alt.RData")
save(i_list, file = "MultiCancerGeneilist_QuartALL_Alt.RData")
save(j_list, file = "MultiCancerjlist_QuartALL_Alt.RData")
...
load("MultiCancerResultsTable_QuartALL_Alt.RData")
load("MultiCancerGeneCountTable_QuartAL_AltL.RData")
...
plot(results_mat_quad[,5],results_mat_quad[,4],ylim=c(0.5,0.7),xlab="Actives Genes",ylab="C-index")
...
# These values will need to be modified if the input data changes
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == -1.4423,    9] <- 1
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == -1.0774,  9] <- 2
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == -0.1987,  9] <- 3
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == -0.1864,    9] <- 4
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == -0.1603, 9] <- 5

results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == -0.1288, 9] <- 6
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == -0.0756, 9] <- 7
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.0242, 9] <- 8
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.0456, 9] <- 9
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.2002,    9] <- 10

results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.364, 9] <- 11
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.4151 ,9] <- 12
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.4733 ,9] <- 13
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.5276 ,9] <- 14
results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.6024 ,9] <- 15

results_mat_long_score_order_df[results_mat_long_score_order_df$AverageScore == 0.6171 ,9] <- 16
