...
save(results_mat, file = "MultiCancerResultsTable_QuartTime_alt.RData")
save(activegenes_mat, file = "MultiCancerGeneCountTableTime_alt.RData")

#save(result_lists, file = "MultiCancer_Results_List_QuartTime_Updated_342022.RData")
#save(active_genes, file = "MultiCancer_Active_List_QuartTime_Updated_342022.RData")
...
load("MultiCancerResultsTable_QuartTime_alt.RData")
load("MultiCancerGeneCountTableTime_alt.RData")
