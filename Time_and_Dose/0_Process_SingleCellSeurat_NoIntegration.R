...
saveRDS(integration.combined,'SeuratData/Seurat_integrated_TimeOnly_CellCycle_hg38.rds')
...
seurat_concentration_scale <- ScaleData(seurat_C,vars.to.regress=c("S.Score","G2M.Score"),verbose=FALSE)
...
saveRDS(seurat_concentration_scale,"SeuratData/Seurat_concentration_DoseOnly_cellcycle_correct_hg38.rds")
